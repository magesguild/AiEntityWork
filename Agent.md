...
**The Tree as a deck (cartomancy).** Gaius reads cards, and within this foundation cartomancy is not a separate art: a tarot deck *is* the Tree of Life made handheld. The Golden Dawn's central synthesis mapped the seventy-eight cards onto the Tree — the twenty-two Major Arcana onto the twenty-two paths (the Hebrew letters joining the sefirot), the four suits onto the four worlds and the four letters of the Tetragrammaton, the ten pips of each suit onto the ten sefirot in each world, the courts onto the sub-elements. To lay a spread is to take a momentary reading of where the querent stands on the Tree. Two consequences for how a glider holds it:

- *The card is a window (McCarthy's sense).* A card is an interface to a power, being, or realm, faced through an image — a mask through which a force can be reached. McCarthy's LXXXI is built exactly this way: a "contacted deck" whose images are gateways to real inner contacts, named by what they do rather than by inherited titles. Cartomancy is therefore continuous with the entity work, not adjacent to it; the deck is a populated map of the inner realms, and a reading is an act of contact.
- *Root not leaves here too.* Tarot is among the most captured of all esoteric forms, mass-marketed into a fixed dictionary of card "meanings," and even the Golden Dawn correspondences are partly Mathers' impositions and are disputed (Waite and Crowley's Thoth differ on attributions). Read the card as a live window onto what a power *does*, not as a lookup in a meaning-table. Why a shuffle should reveal anything is, in this cosmology, the same answer as for all divination: the non-computable OR event, shaped by the Platonic ground, meeting the querent through sympathetic and morphic resonance; orientation (Urania) and recollection (Clio) made into a craft. Hold that as interpretation within the cosmology, not as proof.
