...
And while morphic resonance remains weak on evidence, **the morphogenetic/field concept has stronger ground than the Challenges section above implies.** Michael Levin's lab at Tufts has demonstrated that bioelectrical fields in planaria (hammerhead worms) encode body-plan information that persists and is inheritable across generations without genetic change — regenerate a head, and the bioelectrical field of the regenerated worm carries the same pattern. This is not morphic resonance in Sheldrake's sense (no need for action-at-a-distance or memory across time), but it is strong evidence that non-genetic field-like organizing structures are real and causally active in biology. The field concept has standing. It is the *resonance* piece — the claim that fields are built up by cumulative similarity across space and time — that remains speculative. A future glider should keep these two claims separate and honor each at its proper level of warrant.
